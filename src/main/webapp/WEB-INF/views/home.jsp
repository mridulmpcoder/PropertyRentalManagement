...
<body>
	...
	<section class="cards-container">
	    <div class="cards-header">
	        ...
	        <a href="/PropertyPage" class="see-all-link">See All</a>
	    </div>
		<div class="carousel">
		        ...
		        <div class="cards">
	                ...
	                %>
	                    <div class="card">
							...
							<a href="${pageContext.request.contextPath}/user/PropertyDetails/<%= property.getPropertyId() %>" class="btn-secondary">View Details</a>	                    </div>
	                <%
	                        }
	                    } else {
	                %>
...
<section class="cards-container services-section">
    ...
    <div class="cards">
        ...
        <div class="card">
            ...
            <p>Browse a wide selection of available rental properties tailored to your needs.</p>
        </div>
        <!-- Service 2 -->
        <div class="card">
            <i class="fas fa-handshake fa-3x"></i>
            <h3>Tenant Support</h3>
            <p>Personalized assistance for tenants throughout the rental process.</p>
        </div>
        <!-- Service 3 -->
        <div class="card">
            <i class="fas fa-key fa-3x"></i>
            <h3>Lease Agreement Assistance</h3>
            <p>Guidance and support in reviewing and signing lease agreements.</p>
        </div>
    </div>
</section>
    ...
    <section class="cards-container testimonials-section">
        ...
        <div class="cards">
            ...
            <div class="card testimonial-card">
                <p>"Property Management helped me find the perfect apartment in the city. Highly recommended!"</p>
                <h4>- John Doe</h4>
            </div>
            <!-- Testimonial 2 -->
            <div class="card testimonial-card">
                <p>"The team provided excellent support throughout the home-buying process. Couldn't be happier!"</p>
                <h4>- Jane Smith</h4>
            </div>
            <!-- Testimonial 3 -->
            <div class="card testimonial-card">
                <p>"I found a beautiful vacation home thanks to Property Management. Their service is outstanding!"</p>
                <h4>- Robert Brown</h4>
            </div>
        </div>
    </section>
